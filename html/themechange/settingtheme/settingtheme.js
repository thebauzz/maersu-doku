...
// erscheinen und verschwinden lassen des containers zum wegklicken der Navigation
  document.getElementById("emptycontainer").classList.toggle("containerdisplay");

// entweder einfüge-animation oder entfern-animation der Navigation
  setting = document.getElementById("settings")

    if (setting.classList.contains("inemitdem")) {
      setting.classList.remove("inemitdem");
      setting.classList.add("usemitdem");
    }
    else if (setting.classList.contains("usemitdem")){
      setting.classList.remove("usemitdem");
      setting.classList.add("inemitdem");
    }
    else {
      setting.classList.add("inemitdem");
    }
